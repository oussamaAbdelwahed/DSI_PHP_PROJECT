...
ViewGenerator.appendStatus=function(jsonData,idTarget){
	    ...
	    var imageuser=$("<img alt='utilisateur' class='userpostimage'/><strong class='nomutilisateru'>"+$('#prenom').val()+"</strong>").attr('src',
		  $("#"+jsonData['id_poster']).find(':first').attr("src"));
